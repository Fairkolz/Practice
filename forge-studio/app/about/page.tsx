      ...
      <section className="py-16 md:py-20">
        <div className="mx-auto max-w-6xl px-6">
          ...
          <p className="mb-8 max-w-[480px] text-body-large text-on-surface-variant">
            Forge Studio is a collective of visionary designers and technical masterminds dedicated
            to crafting premium digital experiences for enterprise-scale partners.
          </p>
        </div>
      </section>
      ...
      <section className="bg-surface-container-low py-24">
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="grid gap-6 md:grid-cols-4">
            {values.map((v) => (
              <Card key={v.title} icon={v.icon} title={v.title} text={v.text} />
            ))}
          </div>
        </div>
      </section>
